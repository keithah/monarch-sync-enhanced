...
import { Retailer } from './retailerApi';
import type { RetailerInfo, Order, Item, OrderTransaction } from './retailerApi';
...
export type AmazonInfo = RetailerInfo;
export { Order, Item, OrderTransaction };
